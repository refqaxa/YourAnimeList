...
namespace YourAnimeList.Data.Migrations
{
    ...
    [Migration("20241210141842_UserAnimePlaylist")]
    partial class UserAnimePlaylist
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YourAnimeList.Models.UserAnimeList", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("YourAnimeList.Models.UserAnimeList", b =>
                {
                    b.HasOne("YourAnimeList.Models.Anime", "Anime")
                        .WithMany("UserAnimeLists")
                        .HasForeignKey("AnimeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YourAnimeList.Models.ApplicationUser", "User")
                        .WithMany("UserAnimeLists")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
